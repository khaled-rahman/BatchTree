...
```
$ ./bin/BatchPrEL -input datasets/raw/Graph_8.txt.weighted.mtx -output dataset/output/ -iter 200 -lr 0.8 -batch 128 -algo 2 -nsamples 20 -label datasets/raw/Graph_8.txt.labels -lrforlo 0.5 -iter2nd 200 -scalingbox 400 -box 100 -psamples 600
```
